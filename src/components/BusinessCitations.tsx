...
export const OFFICIAL_NAP = {
  ...
  googleMapsUrl: 'https://maps.google.com/?q=Perkins+Publishers+G%C4%A7ajnsielem+Malta',
  latitude: 36.0261,
  longitude: 14.2853,
...
export const DIRECTORY_CITATIONS: DirectoryCitation[] = [
  {
    ...
    url: 'https://maps.google.com/?q=Perkins+Publishers+G%C4%A7ajnsielem+Malta',
    description: 'Primary verified Google Business Profile in Għajnsielem, Gozo, Malta with verified GPS coordinates, customer review channel, and business hours.',
  ...
  },
  {
    ...
    status: 'Verified Listing',
    url: 'https://www.bing.com/maps?q=Perkins+Publishers+G%C4%A7ajnsielem+Malta',
    description: 'Microsoft Bing verified business directory profile synced with Apple Maps and Windows Search ecosystems.',
    canonicalNapMatch: true,
  ...
  },
  {
    ...
    status: 'Verified Listing',
    url: 'https://maps.apple.com/?q=Perkins+Publishers+Ghajnsielem+Malta',
